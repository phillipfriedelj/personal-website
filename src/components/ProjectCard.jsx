...
export function ProjectCard() {
  ...
  return (
    <div className="content-center border flex flex-col space-y-2">
      ...
      <div class="bg-white rounded-full w-1/4 h-5 text-xs inline-flex flex-nowrap overflow-hidden ml-2">
        <ul
          ref={logosRef}
      ...
      <p className="text-white text-xs pl-2">
        ...
        Suspendisse convallis, nulla vel vulputate suscipit, tortor enim gravida
        elit, vel ullamcorper sem lacus at orci.
      </p>
    </div>
  );
}
