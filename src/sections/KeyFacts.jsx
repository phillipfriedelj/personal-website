...
export default function KeyFacts() {
  return (
    <SectionContainer>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 grid-rows-8 lg:grid-rows-11 border-white border h-full">
        <div className="lg:col-span-4 content-center border-b">
          <h3 className="pl-2 font-inter font-bold text-sm sm:text-medium md:text-[30px] lg:text-large leading-none text-white">
            KEY FACTS
          </h3>
        </div>
        <div className="lg:col-span-2 lg:row-span-10 lg:col-start-3 lg:row-start-2 row-start-6 row-end-9 border-l flex flex-col">
        ...
        <div className="lg:row-span-3 lg:col-start-1 lg:row-start-5 row-start-4 border-r flex flex-col">
        ...
        <div className="lg:row-span-3 lg:col-start-2 row-start-5 lg:row-start-5 flex flex-col">
        ...
        <div className="lg:col-span-2 lg:row-span-3 col-start-1 row-start-2 border-b h-full flex flex-col">
        ...
        <div className="lg:col-span-2 lg:row-span-3 lg:row-start-8 row-start-3 border-y flex flex-col">
        ...
        <div className="hidden lg:block lg:col-span-2 lg:row-start-11">
          <div className="flex justify-center w-full h-full space-x-2 bg-orange">
            <IconArrowDown
              color="white"
              stroke={2}
              className="self-center h-5 lg:h-8 w-auto"
            />
